...
def solve_aT3_6p(tracker_points, link_transforms):
    ...
    def parse_json_data(points, transforms, group):
        ...
        for p in group:
            ...
            r = np.array([
                [1 - 2*(rotation[2]**2 + rotation[3]**2), 2*(rotation[1]*rotation[2] - rotation[3]*rotation[0]), 2*(rotation[1]*rotation[3] + rotation[2]*rotation[0])],
                [2*(rotation[1]*rotation[2] + rotation[3]*rotation[0]), 1 - 2*(rotation[1]**2 + rotation[3]**2), 2*(rotation[2]*rotation[3] - rotation[1]*rotation[0])],
                [2*(rotation[1]*rotation[3] - rotation[2]*rotation[0]), 2*(rotation[2]*rotation[3] + rotation[1]*rotation[0]), 1 - 2*(rotation[1]**2 + rotation[2]**2)]
            ])
